...
dir.create(file.path(paste0(outDataDirectory,"data-",n.bags,"-",p.m[1],"-",p.g)),showWarnings=FALSE)
tempDirectory <- paste0(outDataDirectory,"data-",n.bags,"-",p.m[1],"-",p.g)

saveRDS(list(parameters,data),file=paste0(tempDirectory,"/","replicate-",j,".RDS")) 
