####
####
# Study effect of model misspecification: fit a constant mortality constant germination model
# to observations from an age-dependent mortality, constant germination process
####
####
