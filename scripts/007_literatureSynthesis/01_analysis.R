...
df <- read.csv("~/Dropbox/chapter-4/products/table-literature-survey.csv",header=TRUE)
...
pdf("~/Dropbox/chapter-4/analysis/products/figures/figure-meta-1.pdf",width=6,height=6)
...
pdf("~/Dropbox/chapter-4/analysis/products/figures/figure-meta-2.pdf",width=6,height=6)
...
pdf("~/Dropbox/chapter-4/analysis/products/figures/figure-meta-3.pdf",width=6,height=6)
...
pdf("~/Dropbox/chapter-4/analysis/products/figures/figure-meta-4.pdf",width=6,height=6)
